...
*Depending on your system, install correct dependencies...*

(venv)$ pip install -r system/dependencies.txt
...
###Remove nginx defaults in sites-enabled/sites-available
...
###Make sure your DB port matches the one you've told Amazon the database will be using (likely 3306):

```bash
# From within your project folder
$ sudo nano /app/config/database.py
# DB_PORT = ???? (probably 3306 depending on your EC2 settings)
```
